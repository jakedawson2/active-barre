...
class App extends Component {
	...
	<div class="top">
    	<ul>
            ...
            <li><a href="#img_4"><img src={image4} /></a></li>
            <li><a href="#img_5"><img src={image5}/></a></li>
            <li><a href="#img_6"><img src={image6} /></a></li>
            <li><a href="#img_7"><img src={image7}/></a></li>
            <li><a href="#img_8"><img src={image8} /></a></li>
            <li><a href="#img_9"><img src={image9} /></a></li>
        </ul>
        ...
        <a href="#_4" class="lightbox trans" id="img_4"><img src={image4}/></a>
        <a href="#_5" class="lightbox trans" id="img_5"><img src={image5}/></a>
        <a href="#_6" class="lightbox trans" id="img_6"><img src={image6}/></a>
        <a href="#_7" class="lightbox trans" id="img_7"><img src={image7}/></a>
        <a href="#_8" class="lightbox trans" id="img_8"><img src={image8}/></a>
